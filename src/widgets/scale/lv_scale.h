...
enum {
    LV_PROPERTY_ID(SCALE, ANGLE_RANGE,       LV_PROPERTY_TYPE_INT,  0),
    LV_PROPERTY_ID(SCALE, DRAW_TICKS_ON_TOP, LV_PROPERTY_TYPE_BOOL, 1),
    LV_PROPERTY_ID(SCALE, FIRST_TICK_WIDTH,  LV_PROPERTY_TYPE_INT,  2),
    LV_PROPERTY_ID(SCALE, IS_CACHED,         LV_PROPERTY_TYPE_BOOL, 3),
    LV_PROPERTY_ID(SCALE, LABEL_GAP,         LV_PROPERTY_TYPE_INT,  4),
    LV_PROPERTY_ID(SCALE, LABEL_SHOW,        LV_PROPERTY_TYPE_BOOL, 5),
    LV_PROPERTY_ID(SCALE, LAST_TICK_WIDTH,   LV_PROPERTY_TYPE_INT,  6),
    LV_PROPERTY_ID(SCALE, MAJOR_TICK_EVERY,  LV_PROPERTY_TYPE_INT,  7),
    LV_PROPERTY_ID(SCALE, POST_DRAW,         LV_PROPERTY_TYPE_BOOL, 8),
    LV_PROPERTY_ID(SCALE, RANGE_MAX,         LV_PROPERTY_TYPE_INT,  9),
    LV_PROPERTY_ID(SCALE, RANGE_MAX_VALUE,   LV_PROPERTY_TYPE_INT,  10),
    LV_PROPERTY_ID(SCALE, RANGE_MIN,         LV_PROPERTY_TYPE_INT,  11),
    LV_PROPERTY_ID(SCALE, RANGE_MIN_VALUE,   LV_PROPERTY_TYPE_INT,  12),
    LV_PROPERTY_ID(SCALE, ROTATION,          LV_PROPERTY_TYPE_INT,  13),
    LV_PROPERTY_ID(SCALE, TOTAL_TICK_COUNT,  LV_PROPERTY_TYPE_INT,  14),
